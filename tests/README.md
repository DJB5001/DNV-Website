...
| `laden-test.mjs` | Die Auktionsliste steht, bevor der 33-MB-Verlauf da ist; keine Zeitstempel mehr an den Adressen; was der Service Worker speichern darf | Browser |
